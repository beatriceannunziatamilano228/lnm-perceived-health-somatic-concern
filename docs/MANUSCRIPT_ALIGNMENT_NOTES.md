...
- The Kletenik cross-modal comparator is NeuroVault image 795501. The historical `p = 0.93` should be retained only after it is regenerated by the documented workflow; otherwise report the comparison descriptively.
